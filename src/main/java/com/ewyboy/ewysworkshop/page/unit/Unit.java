...
public abstract class Unit {
    ...
    public void draw(GuiBase gui, int mX, int mY) {
        ...
        /*if ((EwysWorkshop.nei != null || charging) && gui.inBounds(this.x + x, this.y + y, ARROW_WIDTH, ARROW_HEIGHT, mX, mY)) {
            if (!charging) {
    ...
    public void onClick(GuiBase gui, int mX, int mY) {
        /*if (EwysWorkshop.nei != null &&gui.inBounds(this.x + getArrowX(), this.y + getArrowY(), ARROW_WIDTH, ARROW_HEIGHT, mX, mY)) {
