...
public class DataReader {
    ...
    public int readData(com.ewyboy.ewysworkshop.network.IBitCount count) {
    ...
    public int readSignedData(com.ewyboy.ewysworkshop.network.IBitCount count) {
    ...
    public String readString(com.ewyboy.ewysworkshop.network.IBitCount bits) {
