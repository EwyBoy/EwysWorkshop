...
import static com.ewyboy.ewysworkshop.main.EwysWorkshop.packetHandler;
...
public class DataWriter {
    ...
    private FMLProxyPacket createPacket() {
        writeFinalBits();
        return new FMLProxyPacket(stream, StringMap.Channel);
    }
    ...
    public void writeBoolean(boolean data) {
        writeData(data ? 1 : 0, com.ewyboy.ewysworkshop.network.StandardCounts.BOOLEAN);
    }

    public void writeByte(int data) {
        writeData(data, com.ewyboy.ewysworkshop.network.StandardCounts.BYTE);
    }

    public void writeShort(int data) {
        writeData(data, com.ewyboy.ewysworkshop.network.StandardCounts.SHORT);
    }

    public void writeInteger(int data) {
        writeData(data, com.ewyboy.ewysworkshop.network.StandardCounts.INTEGER);
    }
